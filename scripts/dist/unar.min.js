...
var pathVal = function pathVal(obj, path, val) {
	// var o = { a: { b: { c: 1 } } }
	// pathVal(o, 'a.b.c')
	// pathVal(o, 'a.b.c',2)
...
var Attr = function () {
	function Attr() {
		_classCallCheck$2(this, Attr);
	}

	_createClass$2(Attr, null, [{
		key: "isExpression",
...
var DomEvent = function () {
	function DomEvent() {
		_classCallCheck$3(this, DomEvent);
	}

	_createClass$3(DomEvent, null, [{
		key: "bind",
...
var Register = function () {
	function Register() {
		_classCallCheck$4(this, Register);
	}

	_createClass$4(Register, null, [{
...
var Detictive = function () {
	function Detictive() {
		_classCallCheck$5(this, Detictive);
	}

	_createClass$5(Detictive, null, [{
		key: "bind",
		value: function bind(node, prop, exp, vm) {
			...
			if (prop === 'value') {
				var fn = function fn(e) {
					return pathVal(vm, exp, e.target.value);
				};
...
var Templater = function () {
	function Templater(selector, vm) {
		_classCallCheck$6(this, Templater);
			...
			if (node.nodeType === 3) {
				if (Attr.isExpression(node.data)) {
					...
					var _Attr$expressionKey = Attr.expressionKey(node.data),
					    _Attr$expressionKey2 = _slicedToArray$1(_Attr$expressionKey, 4),
